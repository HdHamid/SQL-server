...
select *,
case when avg_fragmentation_in_percent between 10 and 30 then 
'ALTER INDEX '+index_name+' ON ['+schema_name+'].['+table_name+'] REORGANIZE  WITH ( LOB_COMPACTION = ON )'
...
/*, IGNORE_DUP_KEY = OFF*/, RESUMABLE = OFF, ONLINE = OFF
, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)'
end AS Command
 from #TblIndx order by avg_fragmentation_in_percent desc
```
